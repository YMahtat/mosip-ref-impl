...
export class DialougComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.input && this.input.applicantEmail) {
            this.applicantEmail = this.input.applicantEmail;
            this.validateEmail();
        }
        if (this.input && this.input.applicantNumber) {
            this.applicantNumber = this.input.applicantNumber;
            this.validateMobile();
        }
    }
