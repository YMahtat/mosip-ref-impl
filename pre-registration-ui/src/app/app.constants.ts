...
export const IDS = {
    ...
    expiryPeriodWithoutBooking: 'mosip.id.nobooking.exp.period'
};
...
export const TRANSLITERATE_FIELDS = ["lastName", "firstName", "addressLine1", "addressLine2", "addressLine3", "parentOrGuardianfirstName", "parentOrGuardianlastName"];
